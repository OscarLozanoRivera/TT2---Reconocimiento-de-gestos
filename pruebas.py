...
root = tk.Tk()
btn = RoundedButton(text="This is a \n rounded button", radius=100, btnbackground="black", btnforeground="#ffffff", clicked=func)
btn.pack(expand=True, fill="both")
btn2 = RoundedButton(text="This is a \n ddrounded button", radius=100, btnbackground="#0078ff", btnforeground="#ffffff", clicked=func)
